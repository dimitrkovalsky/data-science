...
/**
 * Created by dkovalskyi on 30.03.2017.
 */
public class RestrictedBoltzmannMachine {
    public static void main(String[] args) throws IOException {
        ...
        MnistDataSetIterator iterator = new MnistDataSetIterator(100, MnistDataFetcher.NUM_EXAMPLES, true);
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new RBM.Builder().nIn(numberOfRows * numberOfColumns).nOut(1000).lossFunction(LossFunctions.LossFunction.KL_DIVERGENCE).build())
                ...
                .layer(9, new OutputLayer.Builder(LossFunctions.LossFunction.MSE).activation(Activation.SIGMOID).nIn(1000).nOut(numberOfRows * numberOfColumns).build())
        ...
        File modelFile = new File("savedModel");
